...
const InteractiveBackground: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-0 pointer-events-none flex items-center justify-center overflow-hidden bg-paper perspective-[1000px]">
      ...
      {/* Static Background Texture/Noise Overlay could go here if needed */}
      <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/concrete-wall.png')] opacity-[0.4] mix-blend-multiply"></div>
    </div>
  );
};
